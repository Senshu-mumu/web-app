...
// import { PRIORITY_ORDER, type Task, type TaskCreate } from "@/lib/types";
// import { fetchTasks, createTask, deleteTask, setTaskAchievement, fetchMe, logoutServer } from "@/lib/api";
...
//       setLoading(true);
//       try {
//         await fetchMe();   // ここが401なら例外になる
//         await reload();
//       } catch (e) {
//         // 未ログイン or トークン無効 → loginへ
...
//         <Button variant="outline" onClick={() => (window.location.href = "/settings/delete")}>
//           アカウント削除
//         </Button>
//         <Button
//           variant="outline"
